...
//import "js/ItemDevice.js" as MyDevice

//import "js/Signal.js" as Signal
...
Item {
    ...
    Window
    {
        ...
        // @disable-check M306
      //  Component.onCompleted: //find.Work();
        ...
        TableView {
            ...
            onDoubleClicked:screenObject.capture("Подключение устрйоств.jpg"),messageDialog_button_FindIP_1.close();
    ...
    GridLayout {
        ...
        Rectangle {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    if(mdelButton.text == "Подключить")
                    {
                        ...
                        screenObject.capture("Подключение Источника питания.jpg")
                    }
                    else
                    {
            ...
            Connections{
                ...
                onSignal_Ok :
                {
                    ...
                    if(good)
                    {
                        ...
                        screenObject.capture("Подключение Источника питания прошло успешно.jpg")
                    ...
                    else
                    {
                        ...
                        screenObject.capture("Подключение Источника питания прошло плохо.jpg")
                    }
            ...
            MouseArea {
                ...
                onHeightChanged: if(skyblue2.visible == false && rectangle1.focus) skyblue.height = rectangle1.height+20, skyblue.x = rectangle1.x, skyblue.y = rectangle1.y
                onWidthChanged:  if(skyblue2.visible == false && rectangle1.focus) skyblue.width = rectangle1.width+20, skyblue.x = rectangle1.x, skyblue.y = rectangle1.y
            }
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onHeightChanged: if(skyblue2.visible == false && rectangle2.focus) skyblue.height = rectangle2.height+20, skyblue.x = rectangle2.x, skyblue.y = rectangle2.y //console.log()
                onWidthChanged:  if(skyblue2.visible == false && rectangle2.focus) skyblue.width = rectangle2.width+20, skyblue.x = rectangle2.x, skyblue.y = rectangle2.y
        ...
        Rectangle {
                ...
                Connections{
                    ...
                    onSignal_Ok :
                    {
                        ...
                        if(good)
                        {
                            ...
                            modelDevice7.text = n6700_2.name;
            ...
            MouseArea {
                ...
                onHeightChanged: if(skyblue2.visible == false && rectangle7.focus) skyblue.height = rectangle7.height+20, skyblue.x = rectangle7.x, skyblue.y = rectangle7.y //console.log()
                onWidthChanged:  if(skyblue2.visible == false && rectangle7.focus) skyblue.width = rectangle7.width+20, skyblue.x = rectangle7.x, skyblue.y = rectangle7.y
        ...
        Rectangle {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    if(mdelButton2.text == "Подключить")
                    {
                        ...
                        screenObject.capture("Подключение Имитатора.jpg")
                    }
                    else
                    {
                ...
                Connections{
                    ...
                    onSignal_Ok :
                    {
                        ...
                        if(good)
                        {
                            ...
                            screenObject.capture("Подключение Имитатора прошло успешно.jpg")
                        ...
                        else
                        {
                            ...
                            screenObject.capture("Подключение Имитатора прошло плохо.jpg")
                        }
            ...
            MouseArea {
                ...
                onHeightChanged: if(skyblue2.visible == false && rectangle3.focus) skyblue.height = rectangle3.height+20, skyblue.x = rectangle3.x, skyblue.y = rectangle3.y
                onWidthChanged:  if(skyblue2.visible == false && rectangle3.focus) skyblue.width = rectangle3.width+20, skyblue.x = rectangle3.x, skyblue.y = rectangle3.y
            }
        ...
        Rectangle {
                ...
                Connections{
                    ...
                    onSignal_Ok :
                    {
                        ...
                        if(good)
                        {
                            ...
                            screenObject.capture("Подключение Осцилографа прошло успешно.jpg")
                        ...
                        else
                        {
                            ...
                            screenObject.capture("Подключение Осцилографа прошло плохо.jpg")
                        }
            ...
            MouseArea {
                ...
                onHeightChanged: if(skyblue.visible == false && rectangle4.focus) skyblue2.height = rectangle4.height+20, skyblue2.x = rectangle4.x, skyblue2.y = rectangle4.y
                onWidthChanged:  if(skyblue.visible == false && rectangle4.focus) skyblue2.width = rectangle4.width+20, skyblue2.x = rectangle4.x, skyblue2.y = rectangle4.y
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onHeightChanged: if(skyblue.visible == false && rectangle5.focus) skyblue2.height = rectangle5.height+20, skyblue2.x = rectangle5.x, skyblue2.y = rectangle5.y
                onWidthChanged:  if(skyblue.visible == false && rectangle5.focus) skyblue2.width = rectangle5.width+20, skyblue2.x = rectangle5.x, skyblue2.y = rectangle5.y
            }
        ...
        Rectangle {
            ...
            GridView
            {
                ...
                MouseArea {
                    ...
                    onHeightChanged: if(skyblue.visible == false && rectangle6.focus) skyblue2.height = rectangle6.height+20, skyblue2.x = rectangle6.x, skyblue2.y = rectangle6.y
                    onWidthChanged:  if(skyblue.visible == false && rectangle6.focus) skyblue2.width = rectangle6.width+20, skyblue2.x = rectangle6.x, skyblue2.y = rectangle6.y
                }
                        ...
                        Button {
                            ...
                            onClicked: {
                                ...
                                if(mdelButtonNP.text == qsTr("Подключить"))
                                {
                                    ...
                                    screenObject.capture("Подключение COM приемника 1.jpg")
                                ...
                                onSignal_Ok :
                                {
                                    ...
                                    if(good)
                                    {
                                        ...
                                        menuRectItemDashboardNP.color = "green"
                                         ...
                                         screenObject.capture("Подключение COM приемника 1 успешно.jpg")
                                    ...
                                    else
                                    {
                                        ...
                                        screenObject.capture("Подключение COM приемника 1 отрицательно.jpg")
                                    }
